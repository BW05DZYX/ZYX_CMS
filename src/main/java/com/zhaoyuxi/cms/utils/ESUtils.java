...
public class ESUtils {
	...
	public static AggregatedPage<?> selectObjects(ElasticsearchTemplate elasticsearchTemplate, Class<?> clazz,
			Integer page, Integer pageSize, String sortField, String fieldNames[], String value, String hot) {
		...
		if (value != null && !"".equals(value)) {
			...
			/*
			 * queryBuilder = QueryBuilders.multiMatchQuery(value, fieldNames); QueryBuilder
			 * queryBuilder2=QueryBuilders.matchQuery("hot", "1");
			 */

//			queryBuilder = QueryBuilders.matchQuery("title", value).boost(7f);

			if ("hot".equals(hot)) {
				queryBuilder = QueryBuilders.boolQuery().must(QueryBuilders.multiMatchQuery(value, fieldNames))
						.must(QueryBuilders.multiMatchQuery("1", "hot"));
